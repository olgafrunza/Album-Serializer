...
from album.views import home, GenreView, GenreDetailView, AlbumView, AlbumDetailView, ArtistView, ArtistDetailView, SongView, SongDetailView
...
urlpatterns = [
    ...
    path('api//<int:pk>/', SongDetailView.as_view()),
